...
![Angular.js](https://img.shields.io/badge/Angular.js-AC282B?logo=angularjs\&logoColor=white)
...
* **Inventory Management System** — Angular · .NET Core · SQL Server — Real‑time tracking, RBAC, validation rules
* **Cloud Notes (Serverless)** — AWS Lambda · API Gateway · DynamoDB · Cognito — 99.8% uptime, cost‑efficient
* **Student Portal Dashboard** — Node.js · Angular · MongoDB — Real‑time analytics & charts

> 👉 See the `/projects` folder for READMEs and screenshots (add yours here!).
...
* ✉️ Email: **[varsha.puli6@gmail.com](mailto:varsha.puli6@gmail.com)**
* 💼 LinkedIn: [linkedin.com/in/varsha-puli-183118228](https://www.linkedin.com/in/varsha-puli-183118228)
...
I enjoy building user‑friendly, scalable applications and applying data science to real‑world problems in healthcare and education. I’m always learning and open to collaborations — feel free to reach out!
